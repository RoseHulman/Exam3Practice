...
def run_test_zero_changer():
    ...
    test2 = ([0, 0, 0, 0], [7, 0, 0, 8, 4, 0], [8, 58, 28], [8, 0, 2])
    expected2 = ([1, 2, 3, 4], [7, 5, 6, 8, 4, 7], [8, 58, 28], [8, 8, 2])
    zero_changer(test2)
    print()
    print('Test 2:')
    ...
    test3 = ([0, 4, 0, 9], [0, 0, 0, 1, 0, 0], [0, 4, 0], [0, 0, 4])
    expected3 = ([1, 4, 2, 9], [3, 4, 5, 1, 6, 7], [8, 4, 9], [10, 11, 4])
    zero_changer(test3)
    print()
    print('Test 3:')
